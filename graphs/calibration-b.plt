...
set ylabel "Number of brokers (b)" 
...
'calibration-6-16-BroMax.dat' u 4:6 w lp pt 7 title "r = 6 | BroMax",\
'calibration-6-16-BroMin.dat' u 4:6 w lp pt 8 title "r = 6 | BroMin"
#    EOF
